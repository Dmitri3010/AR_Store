...
namespace ArStore.API.Db
{
    public static class SimpleRepository
    {
        ...
        public static TEntity Single<TEntity>(Func<TEntity, bool> predicate) where TEntity : Base
        {
            if (predicate == null)
            {
        ...
        public static TEntity Upsert<TEntity>(this TEntity value) where TEntity : Base
        {
            if (value == null)
            {
        ...
        public static void Delete<TEntity>(Func<TEntity, bool> predicate) where TEntity : Base
        {
            Single(predicate)?.Delete();
        }

        public static void Delete<TEntity>(this TEntity value) where TEntity : Base
        {
            if (value == null)
            {
                throw new ArgumentNullException(nameof(value));
        ...
        public static bool Any<TEntity>(Func<TEntity, bool> predicate) where TEntity : Base
        {
            if (predicate == null)
            {
                throw new ArgumentNullException(nameof(predicate));
        ...
        public static int Count<TEntity>(Func<TEntity, bool> predicate = null) where TEntity : Base
        {
        ...
        private static Type EfDbContextType = typeof(EfContext);

        private static (DbSet<TEntity> Entities, DbContext EfContext) CreateEfDB<TEntity>() where TEntity : Base
        {
        ...
        private static TEntity EfSingle<TEntity>(Func<TEntity, bool> predicate) where TEntity : Base
        {
            if (predicate == null)
            {
                throw new ArgumentNullException(nameof(predicate));
        ...
        private static IQueryable<TEntity> EfGet<TEntity>(Func<TEntity, bool> predicate = null) where TEntity : Base
        {
            var entities = CreateEfDB<TEntity>().Entities;
        ...
        private static bool EfAny<TEntity>(Func<TEntity, bool> predicate) where TEntity : Base
        {
            if (predicate == null)
            {
                throw new ArgumentNullException(nameof(predicate));
        ...
        private static TEntity EfUpsert<TEntity>(this TEntity value) where TEntity : Base
        {
            if (value == null)
            {
                throw new ArgumentNullException(nameof(value));
            ...
            {
                if (p.PropertyType.BaseType != typeof(Base)) return;
        ...
        private static void EfDelete<TEntity>(this TEntity value) where TEntity : Base
        {
            if (value == null)
            {
                throw new ArgumentNullException(nameof(value));
        ...
        private static int EfCount<TEntity>(Func<TEntity, bool> predicate = null) where TEntity : Base
        {
